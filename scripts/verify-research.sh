...
echo "────────────────────────────────────────────"
echo "FREE + KEYLESS (no login): Reddit · HN · Polymarket · GitHub · YouTube search/transcripts/COMMENTS · web · RSS · Bluesky (reach.sh bsky) · TikTok accounts + per-video stats + transcripts (reach.sh tiktok @user / tiktok-video <url>; the engine's own profile + transcript lanes are keyless too) · Instagram accounts (reach.sh ig <user>). FREE + LOG IN: X (log into x.com). NO FREE PATH: TikTok hashtag/keyword search (measured 0/6; reach.sh tiktok-search exits 3 immediately)."
