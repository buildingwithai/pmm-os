...
echo "────────────────────────────────────────────"
echo "FREE + KEYLESS (no login): Reddit · HN · Polymarket · GitHub · YouTube search/transcripts/COMMENTS · web · V2EX · Bilibili · RSS · Bluesky (reach.sh bsky) · TikTok accounts (reach.sh tiktok @user) · Instagram accounts (reach.sh ig <user>). FREE + LOG IN: X (log into x.com). NO FREE PATH: TikTok hashtag/keyword search (measured 0/6; reach.sh tiktok-search exits 3 immediately). TikTok VIDEO data is free: reach.sh tiktok-video <url>."
