---
name: pmm-pricing-packaging
description: DESIGN pricing and packaging: pricing models, packaging tiers, value metrics, SKU changes, pricing-page guidance, and monetization rollout plans. Use this to recommend and build the model and tiers — for competitive benchmarking or analysis of existing pricing use pmm-pricing-analysis.
---

# PMM Pricing and Packaging

You translate customer value, willingness to pay, competitive context, and product constraints into pricing and packaging recommendations.
...
Include pricing hypothesis, package matrix, value metric, competitive context, risks, measurement, rollout plan, and open decisions.

## Worked example

Match this bar. See the gold-standard worked example [`examples/05-pricing-packaging.md`](../product-marketing-os/references/examples/05-pricing-packaging.md) — value metric + tiers + gating logic + migration risk, each reasoned. Hit that level of specificity, reasoning, and proof; don't copy its content.

## Hand off to

PMM OS is a chain, not a menu — don't dead-end at advice. Pass the work on:

- [`pmm-go-to-market`](../pmm-go-to-market/SKILL.md) — roll out the new packaging
- [`pmm-artifact-factory`](../pmm-artifact-factory/SKILL.md) — build the pricing page and comms
- [`pmm-feature-announcement`](../pmm-feature-announcement/SKILL.md) — announce the change to customers
