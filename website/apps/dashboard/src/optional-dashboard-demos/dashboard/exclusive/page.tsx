...
export default function ExclusivePage() {
  if (authBypassEnabled) {
    return <LocalExclusivePage />;
  }

  return <ClerkExclusivePage />;
}

function ClerkExclusivePage() {
    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>
          Welcome,{' '}
          <span className='font-semibold'>{organization?.name || localTemplateUser.workspace}</span>
    ...
    <PageContainer>
      <div className='space-y-6'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Welcome, <span className='font-semibold'>{localTemplateUser.workspace}</span>! This page
        ...
        <Card>
          <CardHeader>
            <CardTitle>Thank You for Checking Out the Exclusive Page</CardTitle>
            <CardDescription>
              Template mode unlocks this page so the clone can be tested before billing setup.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='text-lg'>Have a wonderful day!</div>
